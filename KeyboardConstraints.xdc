...
set_property IOSTANDARD LVCMOS33 [get_ports {keyboard[8]}]
...
set_property PACKAGE_PIN U16 [get_ports {keyboard[0]}]
set_property PACKAGE_PIN E19 [get_ports {keyboard[1]}]
set_property PACKAGE_PIN U19 [get_ports {keyboard[2]}]
set_property PACKAGE_PIN V19 [get_ports {keyboard[3]}]
set_property PACKAGE_PIN W18 [get_ports {keyboard[4]}]
set_property PACKAGE_PIN U15 [get_ports {keyboard[5]}]
set_property PACKAGE_PIN U14 [get_ports {keyboard[6]}]
set_property PACKAGE_PIN V14 [get_ports {keyboard[7]}]
set_property PACKAGE_PIN V13 [get_ports {keyboard[8]}]
...
set_property PACKAGE_PIN U16 [get_ports dir]
set_property PACKAGE_PIN E19 [get_ports {speed[0]}]
set_property PACKAGE_PIN U19 [get_ports {speed[1]}]

set_property IOSTANDARD LVCMOS33 [get_ports one_pulse_rst_n]
set_property PACKAGE_PIN U16 [get_ports one_pulse_rst_n]
